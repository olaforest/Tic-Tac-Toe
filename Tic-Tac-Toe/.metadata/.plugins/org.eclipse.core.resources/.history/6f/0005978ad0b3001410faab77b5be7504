...
public class GameController implements MouseListener {
	...
	public void mousePressed(MouseEvent event) {
		...
		int xPositionClicked = event.getX() / (gamePanel.PLACEHOLDER_SIZE + gamePanel.GAP/2);
		int yPositionClicked = event.getY() / (gamePanel.PLACEHOLDER_SIZE + gamePanel.GAP/2);
		...
		// Checks if the game has reach an end and display appropriate message.
